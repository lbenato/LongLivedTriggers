...
sign_ctau_VBFH = [
#'VBFH_M15_ctau0',
#'VBFH_M15_ctau0p05','VBFH_M15_ctau0p1',
#'VBFH_M15_ctau1',
#'VBFH_M15_ctau5',
#'VBFH_M15_ctau10',
#'VBFH_M15_ctau25','VBFH_M15_ctau50','VBFH_M15_ctau100','VBFH_M15_ctau500','VBFH_M15_ctau1000','VBFH_M15_ctau2000','VBFH_M15_ctau5000','VBFH_M15_ctau10000',
#'VBFH_M40_ctau0',
#'VBFH_M40_ctau0p05','VBFH_M40_ctau0p1',
#'VBFH_M40_ctau1',
#'VBFH_M40_ctau5',
#'VBFH_M40_ctau10',
#'VBFH_M40_ctau25','VBFH_M40_ctau50','VBFH_M40_ctau100','VBFH_M40_ctau500','VBFH_M40_ctau1000','VBFH_M40_ctau2000','VBFH_M40_ctau5000','VBFH_M40_ctau10000',
#'VBFH_M60_ctau0',
#'VBFH_M60_ctau0p05','VBFH_M60_ctau0p1',
#'VBFH_M60_ctau1',
#'VBFH_M60_ctau5',
#'VBFH_M60_ctau10',
#'VBFH_M60_ctau25','VBFH_M60_ctau50','VBFH_M60_ctau100','VBFH_M60_ctau500','VBFH_M60_ctau1000','VBFH_M60_ctau2000','VBFH_M60_ctau5000','VBFH_M60_ctau10000',
'VBFH_M15_ctau0p1',
'VBFH_M40_ctau0p1',
'VBFH_M60_ctau0p1',
]
...
VBF_TRIG = "GenBquark1.pt > 10 && GenBquark2.pt >10 && GenBquark3.pt > 10 && GenBquark4.pt > 10 && fabs(GenBquark1.eta) < 2.5 &&  fabs(GenBquark2.eta) < 2.5  && fabs(GenBquark3.eta) < 2.5 && fabs(GenBquark4.eta) < 2.5 && (HLT_QuadPFJet_BTagCSV_p016_p11_VBF_Mqq200_v || HLT_QuadPFJet_BTagCSV_p016_p11_VBF_Mqq240_v || HLT_QuadPFJet_BTagCSV_p016_VBF_Mqq460_v || HLT_QuadPFJet_BTagCSV_p016_VBF_Mqq500_v || HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v || HLT_QuadJet45_TripleBTagCSV_p087_v || HLT_HT650_v || HLT_AK8DiPFJet250_200_TrimMass30_BTagCSV_p20_v || HLT_PFHT400_SixJet30_DoubleBTagCSV_p056_v || HLT_AK8PFHT600_TrimR0p1PT0p03Mass50_BTagCSV_p20_v || HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p20_v || HLT_DoubleJetsC100_DoubleBTagCSV_p014_DoublePFJetsC100MaxDeta1p6_v || HLT_DoubleJetsC100_DoubleBTagCSV_p026_DoublePFJetsC160_v || HLT_AK8PFHT650_TrimR0p1PT0p03Mass50_v || HLT_DoubleJetsC112_DoubleBTagCSV_p014_DoublePFJetsC112MaxDeta1p6_v || HLT_DoubleJetsC112_DoubleBTagCSV_p026_DoublePFJetsC172_v || HLT_AK8PFHT700_TrimR0p1PT0p03Mass50_v)"
VBF_TRIG_ONLY = "(HLT_QuadPFJet_BTagCSV_p016_p11_VBF_Mqq200_v || HLT_QuadPFJet_BTagCSV_p016_p11_VBF_Mqq240_v || HLT_QuadPFJet_BTagCSV_p016_VBF_Mqq460_v || HLT_QuadPFJet_BTagCSV_p016_VBF_Mqq500_v || HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v || HLT_QuadJet45_TripleBTagCSV_p087_v || HLT_HT650_v || HLT_AK8DiPFJet250_200_TrimMass30_BTagCSV_p20_v || HLT_PFHT400_SixJet30_DoubleBTagCSV_p056_v || HLT_AK8PFHT600_TrimR0p1PT0p03Mass50_BTagCSV_p20_v || HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p20_v || HLT_DoubleJetsC100_DoubleBTagCSV_p014_DoublePFJetsC100MaxDeta1p6_v || HLT_DoubleJetsC100_DoubleBTagCSV_p026_DoublePFJetsC160_v || HLT_AK8PFHT650_TrimR0p1PT0p03Mass50_v || HLT_DoubleJetsC112_DoubleBTagCSV_p014_DoublePFJetsC112MaxDeta1p6_v || HLT_DoubleJetsC112_DoubleBTagCSV_p026_DoublePFJetsC172_v || HLT_AK8PFHT700_TrimR0p1PT0p03Mass50_v)"
...
def plot_kin(var, cutlist="", addlabel=""):
    file = {}
    nevt = {}
    tree = {}
    chain = {}
    ...
    for i, s in enumerate(sign):
        if 'WplusH' in samples[s]['files'][0]:
            ...
            signame = "VBFH"
        ctau_ind = str(samples[s]['ctau']).replace(".","_")
        ...
        tree[s] = file[s].Get("trigger/tree")
        effs[s] = (float(tree[s].GetEntries(cutlist))/(nevt[s]))
        file[s].Close()
        massimo = 0
        if var == "GenBquark1.eta":
            hist[s] = TH1F(s, ";"+" #eta gen b_{1}", 50, -5, 5)
        elif var == "GenBquark2.eta":
            hist[s] = TH1F(s, ";"+" #eta gen b_{2}", 50, -5, 5)
        elif var == "GenBquark3.eta":
            hist[s] = TH1F(s, ";"+" #eta gen b_{3}", 50, -5, 5)
        elif var == "GenBquark4.eta":
            hist[s] = TH1F(s, ";"+" #eta gen b_{4}", 50, -5, 5)
        elif var == "GenBquark1.pt":
            hist[s] = TH1F(s, ";"+" p_{T} gen b_{1}", 50, 0, 200)
        elif var == "GenBquark2.pt":
            hist[s] = TH1F(s, ";"+" p_{T} gen b_{2}", 50, 0, 200)
        elif var == "GenBquark3.pt":
            hist[s] = TH1F(s, ";"+" p_{T} gen b_{3}", 50, 0, 200)
        elif var == "GenBquark4.pt":
            hist[s] = TH1F(s, ";"+" p_{T} gen b_{4}", 50, 0, 200)
        elif var == "GenLongLived1.pt":
            hist[s] = TH1F(s, ";"+" p_{T} gen #pi_{1}", 50, 0, 200)
        elif var == "Jet1.pt":
            hist[s] = TH1F(s, ";"+" p_{T} reco j_{1}", 50, 0, 500)
        elif var == "Jet2.pt":
            hist[s] = TH1F(s, ";"+" p_{T} reco j_{2}", 50, 0, 500)
        elif var == "Jet3.pt":
            hist[s] = TH1F(s, ";"+" p_{T} reco j_{3}", 50, 0, 500)
        elif var == "Jet4.pt":
            hist[s] = TH1F(s, ";"+" p_{T} reco j_{4}", 50, 0, 500)
        elif var == "Jet1.CSV":
            hist[s] = TH1F(s, ";"+" CSV reco j_{1}", 50, 0, 1)
        elif var == "Jet2.CSV":
            hist[s] = TH1F(s, ";"+" CSV reco j_{2}", 50, 0, 1)
        elif var == "Jet3.CSV":
            hist[s] = TH1F(s, ";"+" CSV reco j_{3}", 50, 0, 1)
        elif var == "Jet4.CSV":
            hist[s] = TH1F(s, ";"+" CSV reco j_{4}", 50, 0, 1)
        hist[s].Sumw2()
        #file[s] = TFile(NTUPLEDIR + samples[s]['files'][0] + ".root", "READ")
        #nevt[s] = file[s].Get("trigger/tree").GetEntriesFast()
        #nevt[s] = (file[s].Get('counter/c_nEvents')).GetBinContent(1)
        chain[s] = TChain("trigger/tree")
        #nevt[s] = chain[s].Get("trigger/tree").GetEntriesFast()
        chain[s].Add(NTUPLEDIR + samples[s]['files'][0] + ".root")
        chain[s].Project(s, var, cutlist)
        hist[s].SetOption("%s" % chain[s].GetTree().GetEntriesFast())
        if cutlist != "":
            print cutlist
            hist[s].SetTitle(cutlist)
        hist[s].Scale(1./nevt[s])
        hist[s].SetLineColor(colors[i])
        hist[s].SetLineWidth(3)
        print "Eff: ", s, float("{0:.0f}".format(effs[s]*100))
        massimo = max(massimo,hist[s].GetMaximum())
    c1 = TCanvas("c1", "Signals", 800, 800)
    #c1.SetLogy()
    c1.cd()
    leg = TLegend(0.6, 0.65, 0.99, 0.9)
    for i, s in enumerate(sign):
        hist[s].Draw("HIST,sames")
        hist[s].SetMaximum(massimo*1.1)
        #leg.AddEntry(hist[s],s + ", eff: " + str(float("{0:.1f}".format(effs[s]*100)))+"%","l")
        leg.AddEntry(hist[s],s + ", eff: " + str(int(round(effs[s]*100,0)))+"%","l")
    leg.Draw()
    string_name = var.replace(".","_")
    c1.Print("$CMSSW_BASE/src/Analysis/ALPHA/macro/Efficiency/"+string_name+signame+addlabel+"_ctau"+str(ctau_ind)+".pdf")
    c1.Print("$CMSSW_BASE/src/Analysis/ALPHA/macro/Efficiency/"+string_name+signame+addlabel+"_ctau"+str(ctau_ind)+".png")
    c1.Update()
####
...
#plot_kin(var="GenBquark1.eta")
#plot_kin(var="GenBquark2.eta",cutlist="fabs(GenBquark1.eta) < 2.5")
#plot_kin(var="GenBquark3.eta",cutlist="fabs(GenBquark1.eta) < 2.5 && fabs(GenBquark2.eta) < 2.5")
#plot_kin(var="GenBquark4.eta",cutlist="fabs(GenBquark1.eta) < 2.5 && fabs(GenBquark2.eta) < 2.5 && fabs(GenBquark3.eta) < 2.5")
#plot_kin(var="GenBquark1.pt")
#plot_kin(var="GenBquark2.pt", cutlist = "GenBquark1.pt > 10")
#plot_kin(var="GenBquark3.pt", cutlist = "GenBquark1.pt > 10 && GenBquark2.pt > 10")
#plot_kin(var="GenBquark4.pt", cutlist = "GenBquark1.pt > 10 && GenBquark2.pt > 10 && GenBquark3.pt > 10")

#plot_kin(var="GenBquark1.pt", cutlist = "fabs(GenBquark1.eta) < 2.5 && fabs(GenBquark2.eta) < 2.5 && fabs(GenBquark3.eta) < 2.5 && fabs(GenBquark4.eta) < 2.5", addlabel="_eta_cut_b1234")
#plot_kin(var="GenBquark2.pt", cutlist = "fabs(GenBquark1.eta) < 2.5 && fabs(GenBquark2.eta) < 2.5 && fabs(GenBquark3.eta) < 2.5 && fabs(GenBquark4.eta) < 2.5 && GenBquark1.pt > 10", addlabel="_eta_cut_b1234")
#plot_kin(var="GenBquark3.pt", cutlist = "fabs(GenBquark1.eta) < 2.5 && fabs(GenBquark2.eta) < 2.5 && fabs(GenBquark3.eta) < 2.5 && fabs(GenBquark4.eta) < 2.5 && GenBquark1.pt > 10 && GenBquark2.pt > 10", addlabel="_eta_cut_b1234")
#plot_kin(var="GenBquark4.pt", cutlist = "fabs(GenBquark1.eta) < 2.5 && fabs(GenBquark2.eta) < 2.5 && fabs(GenBquark3.eta) < 2.5 && fabs(GenBquark4.eta) < 2.5 && GenBquark1.pt > 10 && GenBquark2.pt > 10 && GenBquark3.pt > 10", addlabel="_eta_cut_b1234")

#plot_kin(var="GenLongLived1.pt", cutlist = "", addlabel = "")
#plot_kin(var="GenLongLived1.pt", cutlist = "fabs(GenBquark1.eta) < 2.5 && fabs(GenBquark3.eta) < 2.5 && fabs(GenBquark4.eta) < 2.5", addlabel = "_eta_cut_b134")
#plot_kin(var="GenLongLived1.pt", cutlist = "fabs(GenBquark1.eta) < 2.5 && fabs(GenBquark2.eta) < 2.5 && fabs(GenBquark3.eta) < 2.5 && fabs(GenBquark4.eta) < 2.5", addlabel = "_eta_cut_b1234")
#plot_kin(var="GenLongLived1.pt", cutlist = "GenBquark4.pt > 10 && GenBquark1.pt > 10 && GenBquark2.pt > 10", addlabel = "_pt_cut_b124")
#plot_kin(var="GenLongLived1.pt", cutlist = "GenBquark1.pt > 10 && GenBquark2.pt > 10 && GenBquark3.pt > 10 && GenBquark4.pt > 10", addlabel = "_pt_cut_b1234")
#plot_kin(var="GenLongLived1.pt", cutlist = "fabs(GenBquark1.eta) < 2.5 && fabs(GenBquark2.eta) < 2.5 && fabs(GenBquark3.eta) < 2.5 && fabs(GenBquark4.eta) < 2.5 && GenBquark1.pt > 10 && GenBquark2.pt > 10 && GenBquark3.pt > 10 && GenBquark4.pt > 10", addlabel = "_pteta_cut_b1234")

'''
plot_kin(var="Jet1.pt", cutlist = "fabs(Jet1.eta) < 2.5 && (Jet1.m_q1 || Jet1.m_q2 || Jet1.m_q3 || Jet1.m_q4)", addlabel = "_matched")
plot_kin(var="Jet2.pt", cutlist = "fabs(Jet2.eta) < 2.5 && (Jet2.m_q1 || Jet2.m_q2 || Jet2.m_q3 || Jet2.m_q4)", addlabel = "_matched")
plot_kin(var="Jet3.pt", cutlist = "fabs(Jet3.eta) < 2.5 && (Jet3.m_q1 || Jet3.m_q2 || Jet3.m_q3 || Jet3.m_q4)", addlabel = "_matched")
plot_kin(var="Jet4.pt", cutlist = "fabs(Jet4.eta) < 2.5 && (Jet4.m_q1 || Jet4.m_q2 || Jet4.m_q3 || Jet4.m_q4)", addlabel = "_matched")
plot_kin(var="Jet1.CSV", cutlist = "fabs(Jet1.eta) < 2.5 && (Jet1.m_q1 || Jet1.m_q2 || Jet1.m_q3 || Jet1.m_q4)", addlabel = "_matched")
plot_kin(var="Jet2.CSV", cutlist = "fabs(Jet2.eta) < 2.5 && (Jet2.m_q1 || Jet2.m_q2 || Jet2.m_q3 || Jet2.m_q4)", addlabel = "_matched")
plot_kin(var="Jet3.CSV", cutlist = "fabs(Jet3.eta) < 2.5 && (Jet3.m_q1 || Jet3.m_q2 || Jet3.m_q3 || Jet3.m_q4)", addlabel = "_matched")
plot_kin(var="Jet4.CSV", cutlist = "fabs(Jet4.eta) < 2.5 && (Jet4.m_q1 || Jet4.m_q2 || Jet4.m_q3 || Jet4.m_q4)", addlabel = "_matched")

plot_kin(var="Jet1.pt", cutlist = "(fabs(Jet1.eta) < 2.5) && "+BASECUT, addlabel = "_basecut_no_matched")
plot_kin(var="Jet2.pt", cutlist = "(fabs(Jet2.eta) < 2.5) && "+BASECUT, addlabel = "_basecut_no_matched")
plot_kin(var="Jet3.pt", cutlist = "(fabs(Jet3.eta) < 2.5) && "+BASECUT, addlabel = "_basecut_no_matched")
plot_kin(var="Jet4.pt", cutlist = "(fabs(Jet4.eta) < 2.5) && "+BASECUT, addlabel = "_basecut_no_matched")
plot_kin(var="Jet1.CSV", cutlist = "(fabs(Jet1.eta) < 2.5) && "+BASECUT, addlabel = "_basecut_no_matched")
plot_kin(var="Jet2.CSV", cutlist = "(fabs(Jet2.eta) < 2.5) && "+BASECUT, addlabel = "_basecut_no_matched")
plot_kin(var="Jet3.CSV", cutlist = "(fabs(Jet3.eta) < 2.5) && "+BASECUT, addlabel = "_basecut_no_matched")
plot_kin(var="Jet4.CSV", cutlist = "(fabs(Jet4.eta) < 2.5) && "+BASECUT, addlabel = "_basecut_no_matched")

plot_kin(var="Jet1.pt", cutlist = "( " + BASECUT + " ) " + " && fabs(Jet1.eta) < 2.5 && (Jet1.m_q1 || Jet1.m_q2 || Jet1.m_q3 || Jet1.m_q4)", addlabel = "_basecut")
plot_kin(var="Jet2.pt", cutlist = "( " + BASECUT + " ) " + " && fabs(Jet2.eta) < 2.5 && (Jet2.m_q1 || Jet2.m_q2 || Jet2.m_q3 || Jet2.m_q4)", addlabel = "_basecut")
plot_kin(var="Jet3.pt", cutlist = "( " + BASECUT + " ) " + " && fabs(Jet3.eta) < 2.5 && (Jet3.m_q1 || Jet3.m_q2 || Jet3.m_q3 || Jet3.m_q4)", addlabel = "_basecut")
plot_kin(var="Jet4.pt", cutlist = "( " + BASECUT + " ) " + " && fabs(Jet4.eta) < 2.5 && (Jet4.m_q1 || Jet4.m_q2 || Jet4.m_q3 || Jet4.m_q4)", addlabel = "_basecut")
plot_kin(var="Jet1.CSV", cutlist = "( " + BASECUT + " ) " + " && fabs(Jet1.eta) < 2.5 && (Jet1.m_q1 || Jet1.m_q2 || Jet1.m_q3 || Jet1.m_q4)", addlabel = "_basecut")
plot_kin(var="Jet2.CSV", cutlist = "( " + BASECUT + " ) " + " && fabs(Jet2.eta) < 2.5 && (Jet2.m_q1 || Jet2.m_q2 || Jet2.m_q3 || Jet2.m_q4)", addlabel = "_basecut")
plot_kin(var="Jet3.CSV", cutlist = "( " + BASECUT + " ) " + " && fabs(Jet3.eta) < 2.5 && (Jet3.m_q1 || Jet3.m_q2 || Jet3.m_q3 || Jet3.m_q4)", addlabel = "_basecut")
plot_kin(var="Jet4.CSV", cutlist = "( " + BASECUT + " ) " + " && fabs(Jet4.eta) < 2.5 && (Jet4.m_q1 || Jet4.m_q2 || Jet4.m_q3 || Jet4.m_q4)", addlabel = "_basecut")

#plot_kin(var="Jet1.pt", cutlist = "( " + VBF_TRIG + " ) " + " && (Jet1.m_q1 || Jet1.m_q2 || Jet1.m_q3 || Jet1.m_q4)", addlabel = "_basecut_VBF_trig")
#plot_kin(var="Jet2.pt", cutlist = "( " + VBF_TRIG + " ) " + " && (Jet2.m_q1 || Jet2.m_q2 || Jet2.m_q3 || Jet2.m_q4)", addlabel = "_basecut_VBF_trig")
#plot_kin(var="Jet3.pt", cutlist = "( " + VBF_TRIG + " ) " + " && (Jet3.m_q1 || Jet3.m_q2 || Jet3.m_q3 || Jet3.m_q4)", addlabel = "_basecut_VBF_trig")
#plot_kin(var="Jet4.pt", cutlist = "( " + VBF_TRIG + " ) " + " && (Jet4.m_q1 || Jet4.m_q2 || Jet4.m_q3 || Jet4.m_q4)", addlabel = "_basecut_VBF_trig")
#plot_kin(var="Jet1.CSV", cutlist = "( " + VBF_TRIG + " ) " + " && (Jet1.m_q1 || Jet1.m_q2 || Jet1.m_q3 || Jet1.m_q4)", addlabel = "_basecut_VBF_trig")
#plot_kin(var="Jet2.CSV", cutlist = "( " + VBF_TRIG + " ) " + " && (Jet2.m_q1 || Jet2.m_q2 || Jet2.m_q3 || Jet2.m_q4)", addlabel = "_basecut_VBF_trig")
#plot_kin(var="Jet3.CSV", cutlist = "( " + VBF_TRIG + " ) " + " && (Jet3.m_q1 || Jet3.m_q2 || Jet3.m_q3 || Jet3.m_q4)", addlabel = "_basecut_VBF_trig")
#plot_kin(var="Jet4.CSV", cutlist = "( " + VBF_TRIG + " ) " + " && (Jet4.m_q1 || Jet4.m_q2 || Jet4.m_q3 || Jet4.m_q4)", addlabel = "_basecut_VBF_trig")

plot_kin(var="Jet1.pt", cutlist = "( " + VBF_TRIG + " ) && fabs(Jet1.eta) < 2.5", addlabel = "_basecut_VBF_trig")
plot_kin(var="Jet2.pt", cutlist = "( " + VBF_TRIG + " ) && fabs(Jet2.eta) < 2.5", addlabel = "_basecut_VBF_trig")
plot_kin(var="Jet3.pt", cutlist = "( " + VBF_TRIG + " ) && fabs(Jet3.eta) < 2.5", addlabel = "_basecut_VBF_trig")
plot_kin(var="Jet4.pt", cutlist = "( " + VBF_TRIG + " ) && fabs(Jet4.eta) < 2.5", addlabel = "_basecut_VBF_trig")
plot_kin(var="Jet1.CSV", cutlist = "( " + VBF_TRIG + " ) && fabs(Jet1.eta) < 2.5", addlabel = "_basecut_VBF_trig")
plot_kin(var="Jet2.CSV", cutlist = "( " + VBF_TRIG + " ) && fabs(Jet2.eta) < 2.5", addlabel = "_basecut_VBF_trig")
plot_kin(var="Jet3.CSV", cutlist = "( " + VBF_TRIG + " ) && fabs(Jet3.eta) < 2.5", addlabel = "_basecut_VBF_trig")
plot_kin(var="Jet4.CSV", cutlist = "( " + VBF_TRIG + " ) && fabs(Jet4.eta) < 2.5", addlabel = "_basecut_VBF_trig")
'''

plot_kin(var="Jet1.pt", cutlist = "( " + VBF_TRIG_ONLY + " ) && fabs(Jet1.eta) < 2.5", addlabel = "_only_VBF_trig")
plot_kin(var="Jet2.pt", cutlist = "( " + VBF_TRIG_ONLY + " ) && fabs(Jet2.eta) < 2.5", addlabel = "_only_VBF_trig")
plot_kin(var="Jet3.pt", cutlist = "( " + VBF_TRIG_ONLY + " ) && fabs(Jet3.eta) < 2.5", addlabel = "_only_VBF_trig")
plot_kin(var="Jet4.pt", cutlist = "( " + VBF_TRIG_ONLY + " ) && fabs(Jet4.eta) < 2.5", addlabel = "_only_VBF_trig")
plot_kin(var="Jet1.CSV", cutlist = "( " + VBF_TRIG_ONLY + " ) && fabs(Jet1.eta) < 2.5", addlabel = "_only_VBF_trig")
plot_kin(var="Jet2.CSV", cutlist = "( " + VBF_TRIG_ONLY + " ) && fabs(Jet2.eta) < 2.5", addlabel = "_only_VBF_trig")
plot_kin(var="Jet3.CSV", cutlist = "( " + VBF_TRIG_ONLY + " ) && fabs(Jet3.eta) < 2.5", addlabel = "_only_VBF_trig")
plot_kin(var="Jet4.CSV", cutlist = "( " + VBF_TRIG_ONLY + " ) && fabs(Jet4.eta) < 2.5", addlabel = "_only_VBF_trig")
