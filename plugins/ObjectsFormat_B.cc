...
void ObjectsFormat::FillJetType(JetType& I, const pat::Jet* R, bool isMC) {
  ...
  //  }
    ...
    I.isMatched   = false;
    I.dR_q1       = R->hasUserFloat("dR_q1") ? R->userFloat("dR_q1") : -1;
    I.dR_q2       = R->hasUserFloat("dR_q2") ? R->userFloat("dR_q2") : -1;
    I.dR_q3       = R->hasUserFloat("dR_q3") ? R->userFloat("dR_q3") : -1;
    I.dR_q4       = R->hasUserFloat("dR_q4") ? R->userFloat("dR_q4") : -1;
    I.m_q1        = R->hasUserFloat("dR_q1") ? (R->userFloat("dR_q1")<0.5 ? true : false) : false;
    I.m_q2        = R->hasUserFloat("dR_q2") ? (R->userFloat("dR_q2")<0.5 ? true : false) : false;
    I.m_q3        = R->hasUserFloat("dR_q3") ? (R->userFloat("dR_q3")<0.5 ? true : false) : false;
    I.m_q4        = R->hasUserFloat("dR_q4") ? (R->userFloat("dR_q4")<0.5 ? true : false) : false;
    I.dR_pi1      = R->hasUserFloat("dR_pi1") ? R->userFloat("dR_pi1") : -1;
    I.dR_pi2      = R->hasUserFloat("dR_pi2") ? R->userFloat("dR_pi2") : -1;
}
...
std::string ObjectsFormat::ListGenPType() {return "pt/F:eta/F:phi/F:mass/F:energy/F:charge/I:pdgId/I:status/I";}
